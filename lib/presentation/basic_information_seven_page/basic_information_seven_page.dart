import 'bloc/basic_information_seven_bloc.dart';
import 'models/basic_information_seven_model.dart';
...
class BasicInformationSevenPage extends StatefulWidget {
  const BasicInformationSevenPage({Key? key})
      : super(
          key: key,
        );

  @override
  BasicInformationSevenPageState createState() =>
      BasicInformationSevenPageState();
  static Widget builder(BuildContext context) {
    return BlocProvider<BasicInformationSevenBloc>(
      create: (context) => BasicInformationSevenBloc(BasicInformationSevenState(
        basicInformationSevenModelObj: BasicInformationSevenModel(),
      ))
        ..add(BasicInformationSevenInitialEvent()),
      child: BasicInformationSevenPage(),
    );
  }
}

class BasicInformationSevenPageState extends State<BasicInformationSevenPage>
    with AutomaticKeepAliveClientMixin<BasicInformationSevenPage> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocSelector<
                                BasicInformationSevenBloc,
                                BasicInformationSevenState,
                                BasicInformationSevenModel?>(
                              selector: (state) =>
                                  state.basicInformationSevenModelObj,
                              builder:
                                  (context, basicInformationSevenModelObj) {
                                return CustomDropDown(
                                  ...
                                  items: basicInformationSevenModelObj
                                          ?.dropdownItemList ??
                                      [],
                                  onChanged: (value) {
                                    context
                                        .read<BasicInformationSevenBloc>()
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    BlocSelector<BasicInformationSevenBloc,
                                        BasicInformationSevenState, bool?>(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocSelector<
                                ...
                                TextEditingController?>(
                              selector: (state) =>
                                  state.professionvalueController,
                              builder: (context, professionvalueController) {
                                return CustomFloatingTextField(
                                  margin: getMargin(
                                    top: 14,
                                  ),
                                  controller: professionvalueController,
