import 'bloc/monitoring_one_bloc.dart';
import 'models/monitoring_one_model.dart';
...
class MonitoringOneScreen extends StatelessWidget {
  MonitoringOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<MonitoringOneBloc>(
      create: (context) => MonitoringOneBloc(MonitoringOneState(
        monitoringOneModelObj: MonitoringOneModel(),
      ))
        ..add(MonitoringOneInitialEvent()),
      child: MonitoringOneScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MonitoringOneBloc, MonitoringOneState>(
              ...
              actions: [
                Container(
                  ...
                  child: Stack(
                    ...
                    children: [
                      BlocSelector<MonitoringOneBloc, MonitoringOneState,
                          bool?>(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            text: TextSpan(
                              children: [
                                TextSpan(
                                  ...
                                  style:
                                      CustomTextStyles.bodyMediumInterOnPrimary,
                                ),
                                TextSpan(
                      ...
                      Padding(
                        ...
                        child: DottedBorder(
                          ...
                          child: Container(
                            ...
                            decoration:
                                AppDecoration.outlineRedA700011.copyWith(
                      ...
                      CustomImageView(
                        imagePath: ImageConstant.imgMonitor1,
