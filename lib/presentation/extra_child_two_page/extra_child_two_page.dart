import 'bloc/extra_child_two_bloc.dart';
import 'models/extra_child_two_model.dart';
...
class ExtraChildTwoPage extends StatefulWidget {
  const ExtraChildTwoPage({Key? key})
      : super(
          key: key,
        );

  @override
  ExtraChildTwoPageState createState() => ExtraChildTwoPageState();
  static Widget builder(BuildContext context) {
    return BlocProvider<ExtraChildTwoBloc>(
      create: (context) => ExtraChildTwoBloc(ExtraChildTwoState(
        extraChildTwoModelObj: ExtraChildTwoModel(),
      ))
        ..add(ExtraChildTwoInitialEvent()),
      child: ExtraChildTwoPage(),
    );
  }
}

class ExtraChildTwoPageState extends State<ExtraChildTwoPage>
    with AutomaticKeepAliveClientMixin<ExtraChildTwoPage> {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocSelector<ExtraChildTwoBloc, ExtraChildTwoState,
                                ExtraChildTwoModel?>(
                              selector: (state) => state.extraChildTwoModelObj,
                              builder: (context, extraChildTwoModelObj) {
                                return CustomDropDown(
                                  ...
                                  items:
                                      extraChildTwoModelObj?.dropdownItemList ??
                                          [],
                                  onChanged: (value) {
                                    context
                                        .read<ExtraChildTwoBloc>()
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    BlocSelector<ExtraChildTwoBloc,
                                        ExtraChildTwoState, bool?>(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocSelector<ExtraChildTwoBloc, ExtraChildTwoState,
                                TextEditingController?>(
                              selector: (state) =>
                                  state.fewWordsForSpouController,
                              builder: (context, fewWordsForSpouController) {
                                return CustomFloatingTextField(
                                  margin: getMargin(
                                    top: 16,
                                  ),
                                  controller: fewWordsForSpouController,
