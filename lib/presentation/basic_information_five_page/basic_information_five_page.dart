import 'bloc/basic_information_five_bloc.dart';
import 'models/basic_information_five_model.dart';
...
class BasicInformationFivePage extends StatefulWidget {
  const BasicInformationFivePage({Key? key})
      : super(
          key: key,
        );

  @override
  BasicInformationFivePageState createState() =>
      BasicInformationFivePageState();
  static Widget builder(BuildContext context) {
    return BlocProvider<BasicInformationFiveBloc>(
      create: (context) => BasicInformationFiveBloc(BasicInformationFiveState(
        basicInformationFiveModelObj: BasicInformationFiveModel(),
      ))
        ..add(BasicInformationFiveInitialEvent()),
      child: BasicInformationFivePage(),
    );
  }
}

class BasicInformationFivePageState extends State<BasicInformationFivePage>
    with AutomaticKeepAliveClientMixin<BasicInformationFivePage> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocSelector<
                                BasicInformationFiveBloc,
                                BasicInformationFiveState,
                                BasicInformationFiveModel?>(
                              selector: (state) =>
                                  state.basicInformationFiveModelObj,
                              builder: (context, basicInformationFiveModelObj) {
                                return CustomDropDown(
                                  ...
                                  items: basicInformationFiveModelObj
                                          ?.dropdownItemList ??
                                      [],
                                  onChanged: (value) {
                                    context
                                        .read<BasicInformationFiveBloc>()
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    BlocSelector<BasicInformationFiveBloc,
                                        BasicInformationFiveState, bool?>(
