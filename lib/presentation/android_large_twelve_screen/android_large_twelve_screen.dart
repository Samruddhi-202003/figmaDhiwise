...
class AndroidLargeTwelveScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<AndroidLargeTwelveBloc, AndroidLargeTwelveState>(
              ...
              actions: [
                Container(
                  ...
                  child: Stack(
                    ...
                    children: [
                      BlocSelector<AndroidLargeTwelveBloc,
                          AndroidLargeTwelveState, bool?>(
