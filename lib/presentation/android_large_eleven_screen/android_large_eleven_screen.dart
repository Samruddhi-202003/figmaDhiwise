          ...
          actions: [
            Container(
              ...
              child: Stack(
                ...
                children: [
                  BlocSelector<AndroidLargeElevenBloc, AndroidLargeElevenState,
                      bool?>(
                          ...
                          children: [
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  BlocSelector<
                                      AndroidLargeElevenBloc,
                                      AndroidLargeElevenState,
                                      TextEditingController?>(
                                    selector: (state) =>
                                        state.emergancyfundController,
                                    builder:
                                        (context, emergancyfundController) {
                                      return CustomTextFormField(
                                        controller: emergancyfundController,
                                        hintText: "lbl_emergancy_fund".tr,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    BlocSelector<
                                        ...
                                        TextEditingController?>(
                                      selector: (state) =>
                                          state.groupEightySixController,
                                      builder:
                                          (context, groupEightySixController) {
                                        return CustomTextFormField(
                                          controller: groupEightySixController,
                                          hintText: "msg_priyanka_s_higher".tr,
                                          hintStyle: CustomTextStyles
                                              .titleSmallOnPrimary_1,
