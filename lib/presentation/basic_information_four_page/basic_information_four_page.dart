import 'bloc/basic_information_four_bloc.dart';
import 'models/basic_information_four_model.dart';
...
class BasicInformationFourPage extends StatefulWidget {
  const BasicInformationFourPage({Key? key})
      : super(
          key: key,
        );

  @override
  BasicInformationFourPageState createState() =>
      BasicInformationFourPageState();
  static Widget builder(BuildContext context) {
    return BlocProvider<BasicInformationFourBloc>(
      create: (context) => BasicInformationFourBloc(BasicInformationFourState(
        basicInformationFourModelObj: BasicInformationFourModel(),
      ))
        ..add(BasicInformationFourInitialEvent()),
      child: BasicInformationFourPage(),
    );
  }
}

class BasicInformationFourPageState extends State<BasicInformationFourPage>
    with AutomaticKeepAliveClientMixin<BasicInformationFourPage> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocSelector<
                                BasicInformationFourBloc,
                                BasicInformationFourState,
                                BasicInformationFourModel?>(
                              selector: (state) =>
                                  state.basicInformationFourModelObj,
                              builder: (context, basicInformationFourModelObj) {
                                return CustomDropDown(
                                  ...
                                  items: basicInformationFourModelObj
                                          ?.dropdownItemList ??
                                      [],
                                  onChanged: (value) {
                                    context
                                        .read<BasicInformationFourBloc>()
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    BlocSelector<BasicInformationFourBloc,
                                        BasicInformationFourState, bool?>(
