import 'bloc/basic_information_three_bloc.dart';
import 'models/basic_information_three_model.dart';
...
class BasicInformationThreePage extends StatefulWidget {
  const BasicInformationThreePage({Key? key})
      : super(
          key: key,
        );

  @override
  BasicInformationThreePageState createState() =>
      BasicInformationThreePageState();
  static Widget builder(BuildContext context) {
    return BlocProvider<BasicInformationThreeBloc>(
      create: (context) => BasicInformationThreeBloc(BasicInformationThreeState(
        basicInformationThreeModelObj: BasicInformationThreeModel(),
      ))
        ..add(BasicInformationThreeInitialEvent()),
      child: BasicInformationThreePage(),
    );
  }
}

class BasicInformationThreePageState extends State<BasicInformationThreePage>
    with AutomaticKeepAliveClientMixin<BasicInformationThreePage> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocSelector<
                                BasicInformationThreeBloc,
                                BasicInformationThreeState,
                                BasicInformationThreeModel?>(
                              selector: (state) =>
                                  state.basicInformationThreeModelObj,
                              builder:
                                  (context, basicInformationThreeModelObj) {
                                return CustomDropDown(
                                  ...
                                  items: basicInformationThreeModelObj
                                          ?.dropdownItemList ??
                                      [],
                                  onChanged: (value) {
                                    context
                                        .read<BasicInformationThreeBloc>()
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    BlocSelector<BasicInformationThreeBloc,
                                        BasicInformationThreeState, bool?>(
