import 'bloc/android_large_thirteen_bloc.dart';
...
class AndroidLargeThirteenScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<AndroidLargeThirteenBloc>(
      create: (context) => AndroidLargeThirteenBloc(AndroidLargeThirteenState(
        androidLargeThirteenModelObj: AndroidLargeThirteenModel(),
      ))
        ..add(AndroidLargeThirteenInitialEvent()),
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<AndroidLargeThirteenBloc, AndroidLargeThirteenState>(
              ...
              actions: [
                Container(
                  ...
                  child: Stack(
                    ...
                    children: [
                      BlocSelector<AndroidLargeThirteenBloc,
                          AndroidLargeThirteenState, bool?>(
