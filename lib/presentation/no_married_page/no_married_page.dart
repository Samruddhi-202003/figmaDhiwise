import 'bloc/no_married_bloc.dart';
import 'models/no_married_model.dart';
...
class NoMarriedPage extends StatefulWidget {
  const NoMarriedPage({Key? key})
      : super(
          key: key,
        );

  @override
  NoMarriedPageState createState() => NoMarriedPageState();
  static Widget builder(BuildContext context) {
    return BlocProvider<NoMarriedBloc>(
      create: (context) => NoMarriedBloc(NoMarriedState(
        noMarriedModelObj: NoMarriedModel(),
      ))
        ..add(NoMarriedInitialEvent()),
      child: NoMarriedPage(),
    );
  }
}

class NoMarriedPageState extends State<NoMarriedPage>
    with AutomaticKeepAliveClientMixin<NoMarriedPage> {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Column(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  children: [
                                    BlocSelector<NoMarriedBloc, NoMarriedState,
                            ...
                            BlocSelector<NoMarriedBloc, NoMarriedState,
                                NoMarriedModel?>(
                              selector: (state) => state.noMarriedModelObj,
                              builder: (context, noMarriedModelObj) {
                                return CustomDropDown(
                                  ...
                                  items:
                                      noMarriedModelObj?.dropdownItemList ?? [],
                                  onChanged: (value) {
                                    context
                                        .read<NoMarriedBloc>()
                                    ...
                                    BlocSelector<NoMarriedBloc, NoMarriedState,
                                      ...
                                      builder: (context, yes) {
                                        return CustomCheckboxButton(
                                          ...
                                          onChange: (value) {
                                            context.read<NoMarriedBloc>().add(
                                                ChangeCheckBoxEvent(
                                                    value: value));
                                          },
                                        );
