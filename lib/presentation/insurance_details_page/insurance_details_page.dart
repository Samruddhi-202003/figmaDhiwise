import 'bloc/insurance_details_bloc.dart';
...
class InsuranceDetailsPage extends StatefulWidget {
  const InsuranceDetailsPage({Key? key})
      : super(
          key: key,
        );

  @override
  InsuranceDetailsPageState createState() => InsuranceDetailsPageState();
  static Widget builder(BuildContext context) {
    return BlocProvider<InsuranceDetailsBloc>(
      create: (context) => InsuranceDetailsBloc(InsuranceDetailsState(
        insuranceDetailsModelObj: InsuranceDetailsModel(),
      ))
        ..add(InsuranceDetailsInitialEvent()),
      child: InsuranceDetailsPage(),
    );
  }
}

class InsuranceDetailsPageState extends State<InsuranceDetailsPage>
    with AutomaticKeepAliveClientMixin<InsuranceDetailsPage> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<InsuranceDetailsBloc, InsuranceDetailsState>(
