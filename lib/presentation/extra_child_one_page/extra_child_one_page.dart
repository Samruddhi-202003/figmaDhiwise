import 'bloc/extra_child_one_bloc.dart';
import 'models/extra_child_one_model.dart';
...
class ExtraChildOnePage extends StatefulWidget {
  const ExtraChildOnePage({Key? key})
      : super(
          key: key,
        );

  @override
  ExtraChildOnePageState createState() => ExtraChildOnePageState();
  static Widget builder(BuildContext context) {
    return BlocProvider<ExtraChildOneBloc>(
      create: (context) => ExtraChildOneBloc(ExtraChildOneState(
        extraChildOneModelObj: ExtraChildOneModel(),
      ))
        ..add(ExtraChildOneInitialEvent()),
      child: ExtraChildOnePage(),
    );
  }
}

class ExtraChildOnePageState extends State<ExtraChildOnePage>
    with AutomaticKeepAliveClientMixin<ExtraChildOnePage> {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocSelector<ExtraChildOneBloc, ExtraChildOneState,
                                ExtraChildOneModel?>(
                              selector: (state) => state.extraChildOneModelObj,
                              builder: (context, extraChildOneModelObj) {
                                return CustomDropDown(
                                  ...
                                  items:
                                      extraChildOneModelObj?.dropdownItemList ??
                                          [],
                                  onChanged: (value) {
                                    context
                                        .read<ExtraChildOneBloc>()
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    BlocSelector<ExtraChildOneBloc,
                                        ExtraChildOneState, bool?>(
