import 'bloc/basic_information_eight_bloc.dart';
import 'models/basic_information_eight_model.dart';
...
class BasicInformationEightPage extends StatefulWidget {
  const BasicInformationEightPage({Key? key})
      : super(
          key: key,
        );

  @override
  BasicInformationEightPageState createState() =>
      BasicInformationEightPageState();
  static Widget builder(BuildContext context) {
    return BlocProvider<BasicInformationEightBloc>(
      create: (context) => BasicInformationEightBloc(BasicInformationEightState(
        basicInformationEightModelObj: BasicInformationEightModel(),
      ))
        ..add(BasicInformationEightInitialEvent()),
      child: BasicInformationEightPage(),
    );
  }
}

class BasicInformationEightPageState extends State<BasicInformationEightPage>
    with AutomaticKeepAliveClientMixin<BasicInformationEightPage> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocSelector<
                                BasicInformationEightBloc,
                                BasicInformationEightState,
                                BasicInformationEightModel?>(
                              selector: (state) =>
                                  state.basicInformationEightModelObj,
                              builder:
                                  (context, basicInformationEightModelObj) {
                                return CustomDropDown(
                                  ...
                                  items: basicInformationEightModelObj
                                          ?.dropdownItemList ??
                                      [],
                                  onChanged: (value) {
                                    context
                                        .read<BasicInformationEightBloc>()
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    BlocSelector<BasicInformationEightBloc,
                                        BasicInformationEightState, bool?>(
