import 'bloc/extra_child_three_bloc.dart';
import 'models/extra_child_three_model.dart';
...
class ExtraChildThreePage extends StatefulWidget {
  const ExtraChildThreePage({Key? key})
      : super(
          key: key,
        );

  @override
  ExtraChildThreePageState createState() => ExtraChildThreePageState();
  static Widget builder(BuildContext context) {
    return BlocProvider<ExtraChildThreeBloc>(
      create: (context) => ExtraChildThreeBloc(ExtraChildThreeState(
        extraChildThreeModelObj: ExtraChildThreeModel(),
      ))
        ..add(ExtraChildThreeInitialEvent()),
      child: ExtraChildThreePage(),
    );
  }
}

class ExtraChildThreePageState extends State<ExtraChildThreePage>
    with AutomaticKeepAliveClientMixin<ExtraChildThreePage> {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocSelector<ExtraChildThreeBloc,
                                ExtraChildThreeState, ExtraChildThreeModel?>(
                              selector: (state) =>
                                  state.extraChildThreeModelObj,
                              builder: (context, extraChildThreeModelObj) {
                                return CustomDropDown(
                                  ...
                                  items: extraChildThreeModelObj
                                          ?.dropdownItemList ??
                                      [],
                                  onChanged: (value) {
                                    context
                                        .read<ExtraChildThreeBloc>()
                            ...
                            BlocSelector<ExtraChildThreeBloc,
                                ExtraChildThreeState, TextEditingController?>(
